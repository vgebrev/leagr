...
import { defaultSettings, getEffectiveLeagueSettings, DAY_LEVEL_SETTINGS, LEAGUE_ONLY_SETTINGS } from '$lib/shared/defaults.js';
...
export async function getConsolidatedSettings(date, leagueId) {
    ...
    if (date) {
        ...
        for (const settingKey of DAY_LEVEL_SETTINGS) {
            if (daySettings.hasOwnProperty(settingKey)) {
