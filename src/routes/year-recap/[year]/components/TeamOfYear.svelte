<script>
    ...
    /** @typedef {import('$lib/shared/types.js').YearRecapTeamOfYearEntry} YearRecapTeamOfYearEntry */

    /** @type {{ data: YearRecapTeamOfYearEntry[] | null, initialDelay?: number, duration?: number }} */
