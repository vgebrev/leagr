<script>
    let { children, icon, heading, description } = $props();
</script>

<div
    class="glass flex h-full w-full flex-col overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700">
        ...
        <div class="min-h-0 flex-1 overflow-y-auto px-4 pb-12 md:px-6">
            {@render children()}
        </div>
</div>
