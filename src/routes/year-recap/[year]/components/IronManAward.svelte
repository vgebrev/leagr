<script>
    ...
    /** @typedef {import('$lib/shared/types.js').YearRecapIronManEntry} YearRecapIronManEntry */

    /** @type {{ data: YearRecapIronManEntry[] | null, initialDelay?: number, duration?: number }} */
