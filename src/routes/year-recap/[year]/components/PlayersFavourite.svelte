<script>
    ...
    /** @typedef {import('$lib/shared/types.js').YearRecapPlayersFavourite} YearRecapPlayersFavourite */

    /** @type {{ data: YearRecapPlayersFavourite | null, initialDelay?: number, duration?: number }} */
