<script>
    ...
    /** @typedef {import('$lib/shared/types.js').YearRecapPlayerOfYearEntry} YearRecapPlayerOfYearEntry */

    /** @type {{ data: YearRecapPlayerOfYearEntry[] | null, initialDelay?: number, duration?: number }} */
